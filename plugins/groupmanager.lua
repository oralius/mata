...
elseif lang then
 return "*ارسال لينك ممنوع بوده است.*براي خريد ربات به ايدي ذير پيام دهيد"
end
else
