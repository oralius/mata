...
if matches[1]:lower() == 'lock auto' or matches[1] == 'قفل هوشمند' and is_mod(msg) then
...
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*زمان بندی قبلی از سیستم حذف شد.\n\nلطفا زمان شروع قفل هوشمند را وارد کنید :*', 1, 'md')
redis:del("atolct1"..msg.chat_id_)
redis:del("atolct2"..msg.chat_id_)
redis:del("lc_ato:"..msg.chat_id_)
else
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*لطفا زمان شروع قفل هوشمند را وارد کنید :*', 1, 'md')
end


elseif matches[1]:lower() == 'unlock auto' or matches[1] == 'باز کردن هوشمند' and is_mod(msg) then
if redis:get("atolct1"..msg.chat_id_) and redis:get("atolct2"..msg.chat_id_) then
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*زمانبدی ربات برای قفل کردن هوشمند گروه حذف شد.*', 1, 'md')
redis:del("atolct1"..msg.chat_id_)
redis:del("atolct2"..msg.chat_id_)
redis:del("lc_ato:"..msg.chat_id_)
else
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*قفل هوشمند ثبت نشده است.*', 1, 'md')
end

elseif matches[1]:lower() == 'lockauto stats' or matches[1] == 'وضعیت قفل هوشمند' and is_mod(msg) then
...
if lc then
stats = "*قفل هوشمند فعال است.*"
else
stats = "*قفل هوشمند غیرفعال است.*"
end
...
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*زمان شروع قفل هوشمند در سیستم ثبت شد.\n\nلطفا زمان پایان قفل هوشمند را وارد کنید :*', 1, 'md')
...
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '*شروع قفل هوشمند نمیتوانید با پایان آن یکی باشد.*', 1, 'md')
else
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, 'با موفقیت انجام شد.\n\nگروه شما در ساعات *'..time_1..'* الی *'..matches[1]..':'..matches[2]..'* بصورت هوشمند تعطیل خواهد شد.', 1, 'md')
...
tdcli.sendMessage(msg.chat_id_, msg.id_, 1, 'قفل هوشمند ربات فعال شد.\n\nاز اعضا محترم گروه خواهشمندیم از ارسال هر گونه مطلب در گروه خودداری کنند.\nگروه تا ساعت *'..redis:get("atolct2"..msg.chat_id_)..'* تعطیل میباشد.', 1, 'md')
end
